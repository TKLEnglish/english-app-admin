    ...
    <div className="page">
      ...
      <section className="demo-section">
        <div style={{ display: 'flex', gap: '1rem', marginBottom: '1rem', alignItems: 'flex-end' }}>
          ...
          <Button variant="primary" onClick={openCreate}>+ New Category</Button>
        </div>
      ...
      >
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
          ...
          <TextField label="Name" placeholder="e.g. Animals" required value={form.name} onChange={v => setForm(f => ({ ...f, name: v }))} />
