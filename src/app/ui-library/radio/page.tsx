  ...
  return (
    <div className="page">
      <header className="page-header">
        ...
        <p className="page-description">Option group with horizontal and vertical layout support.</p>
      </header>
      ...
      <section className="demo-section">
        ...
        <div className="demo-card">
          <RadioField label="Size" options={SIZE_OPTIONS} value={size} onChange={setSize} layout="horizontal" />
      ...
      <section className="demo-section">
        ...
        <div className="demo-card">
          <RadioField label="With Error" options={SIZE_OPTIONS} validateMessage="Please choose a size" />
