  ...
  return (
    <div className="page">
      <header className="page-header">
        ...
        <p className="page-description">Boolean toggle with indeterminate state and validation support.</p>
      </header>
      ...
      <section className="demo-section">
        ...
        <div className="demo-card">
          ...
          <CheckboxField label="Subscribe to newsletter" checked={newsletter} onChange={setNewsletter} />
        </div>
      </section>
      ...
      <section className="demo-section">
        ...
        <div className="demo-card">
          <CheckboxField label="With validation error" validateMessage="You must accept the terms" />
      ...
      <section className="demo-section">
        ...
        <div className="demo-card">
          <CheckboxField label="Enable notifications" hint="We will send you important updates via email" />
        </div>
      </section>
    </div>
  )
